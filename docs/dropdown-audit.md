...
| Students | Gender, student status, status filter | Fixed nonempty lists |
...
| Transcript requests | Status | Fixed nonempty list |
...
includes Harmattan, Rain and Long Vacation; the course import is described in
